...
const DetailData = () => {
    ...
    const [ukuranToEdit, setUkuranToEdit] = useState(null);
    ...
    const updatePrompt = async (e) => {
        ...
        try {
            const response = await fetch(`/api/data-balita/${creator}/posts/${ukuranToEdit._id}`, {
                method: 'PATCH',
            ...
            setSubmitting(false);
            setEditMode(false);
            setUkuranToEdit(null);
        }
    }

    const handleEdit = (id, pengukuranId) => {
        router.push(`/edit-pengukuran?id=${id}&pengukuranId=${pengukuranId}`);
    };
                                ...
                                return (
                                    ...
                                    <tr key={ukuran._id}>
                                        ...
                                        <td className="border text-center border-slate-700">
                                            ...
                                            {/* <Link href={`/edit-pengukuran/${creator}/${ukuran._id}`} passHref> */}
                                            <div className="w-28 h-10 text-center px-1 py-2 text-sm rounded-lg font-bold bg-amber-500 text-white cursor-pointer hover:bg-amber-600 flex gap-1 justify-center items-center" onClick={() => handleEdit(creator, ukuran._id)}>
